...
class InstallerGaugeViewCtr(object):
	"""docstring for InstallerGaugeViewCtr"""
	def __init__(self, parent, params = {}):
		super(InstallerGaugeViewCtr, self).__init__();
		self._className_ = InstallerGaugeViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = InstallerGaugeViewUI(parent, curPath = self._curPath, viewCtr = self, params = params);
		self.__ui.initView();
